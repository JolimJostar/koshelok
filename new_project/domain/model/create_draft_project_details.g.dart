...
_$_CreateDraftProjectDetails _$$_CreateDraftProjectDetailsFromJson(
    ...
    _$_CreateDraftProjectDetails(
      ...
      task: (json['tasks'] as List<dynamic>?)
      ...
      expertiseGvs:
          $enumDecodeNullable(_$ExpertiseGvsEnumMap, json['expertiseGvs']),
      pilotingStatus:
          $enumDecodeNullable(_$PilotingStatusEnumMap, json['pilotingStatus']),
      hospitals:
          (json['hospitals'] as List<dynamic>?)?.map((e) => e as int).toList(),
      managerId: json['managerId'] as int?,
      priority: $enumDecodeNullable(_$PrioritizationEnumMap, json['priority']),
      ...
      fundRequestSource: (json['fundRequestList'] as List<dynamic>?)
          ?.map((e) => CreateFundRequest.fromJson(e as Map<String, dynamic>))
          .toList(),
      paymentForDoctor: (json['paymentForDoctors'] as List<dynamic>?)
...
Map<String, dynamic> _$$_CreateDraftProjectDetailsToJson(
        _$_CreateDraftProjectDetails instance) =>
    <String, dynamic>{
      'name': instance.name,
      ...
      'tasks': instance.task?.map((e) => e.toJson()).toList(),
      ...
      'fundRequestList':
          instance.fundRequestSource?.map((e) => e.toJson()).toList(),
      'paymentForDoctors':
          instance.paymentForDoctor?.map((e) => e.toJson()).toList(),
